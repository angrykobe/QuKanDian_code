...
public class MediaController extends FrameLayout implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    private ImageView mPlayImgBig;//大播放按钮
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.pause || view.getId() == R.id.start_play_btn) {
    ...
    public void setPlayState(PlayState playState) {
        ...
        if (playState.equals(PlayState.PLAY)) {
            mPlayImgBig.setVisibility(View.GONE);
        } else {
            mPlayImgBig.setVisibility(View.VISIBLE);
        }
    }
    ...
    private void initView(Context context) {
        ...
        mPlayImgBig = (ImageView) findViewById(R.id.start_play_btn);
    ...
    private void initData() {
        ...
        mPlayImgBig.setOnClickListener(this);
