...
public class ShouTuWebActivity extends BaseNoActionBarActivity implements DialogShareInterface.OnShareListener {
...
//        }
    ...
    public void onShareDialog(final String title, final String desc, final String imgUrl, final String url) {
        ...
        shareDialog.setOnSharedListener(new OnSharedListener() {
            ...
            public void onSharedListener(DetailsBean mDetailsBean, SHARE_MEDIA share_media) {
                UMImage sImg = new UMImage(ShouTuWebActivity.this, imgUrl);
                ...
                UMImage umImage = new UMImage(ShouTuWebActivity.this, UserManager.mShareBean.getWechatIcon());
                umImage.setThumb(sImg);

                web.setThumb(umImage);  //缩略图
                web.setDescription(desc);//描述

                new ShareAction(ShouTuWebActivity.this).setPlatform(share_media).setCallback(mUMShareListener)
                        .withMedia(web)
                        .share();
            }
        });
    ...
    private UMShareListener mUMShareListener = new UMShareListener() {
        ...
        public void onStart(SHARE_MEDIA share_media) {
            ToastUtils.showLongToast(ShouTuWebActivity.this, "正在打开应用");
        }

        @Override
        public void onResult(SHARE_MEDIA share_media) {
            ToastUtils.showLongToast(ShouTuWebActivity.this, "分享成功");
        }

        @Override
        public void onError(SHARE_MEDIA share_media, Throwable throwable) {
            if (throwable.toString().contains("没有安装应用")) {
                ToastUtils.showLongToast(ShouTuWebActivity.this, "没有安装应用");
            }
        }
