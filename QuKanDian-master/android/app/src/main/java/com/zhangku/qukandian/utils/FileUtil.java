...
public class FileUtil {
    ...
    public static boolean saveContentToSdcard(String filename, String content) {
        return saveContentToSdcard(filename, content, false);
    }
    public static boolean saveContentToSdcard(String filename, String content, boolean append) {
        boolean flag = false;
...
//        Logger.i("view_level", allFiles.size() + "");
        return allFiles;
    }
