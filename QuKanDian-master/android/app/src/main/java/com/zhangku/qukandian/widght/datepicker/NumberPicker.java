 ...
 *日期控件
 */
public class NumberPicker extends View implements ExitActivityObserver.ExitActivityObserverAction {
	...
	private void readAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		mDividerLineColor = a.getColor(R.styleable.NumberPicker_textColor, DEFAULT_TEXT_COLOR);
	...
	private void initPaint() {
		...
		mDividerLinePaint.setStrokeWidth(0.5f * mDensity);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mFlagText != null) {
			...
			canvas.drawText(mFlagText, x, (mHeight+ mTextBoundsFlag.height()) / 2 , mFlagTextPaint);
		}
	...
	public NumberPicker setDividerLineColor(int color){
	...
	public void onActivityDestory() {
		...
		mTextPaint = null;
		mFlagTextPaint = null;
		mDividerLinePaint = null;
		mShaderPaintTop = null;
		mShaderPaintBottom = null;
		mTextBounds = null;
		mHighLightRect = null;
		mTextBoundsFlag = null;
		mVelocityTracker = null;
		mSound = null;
		mFlingScroller = null;
		mAdjustScroller = null;
	}
