...
/**
 * Created by yuzuoning on 2017/12/11.
 */
...
public class RingProgressView extends View {
    ...
    public RingProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        textSize = (int) typedArray.getDimension(R.styleable.RingProgressView_textSize1, dip2px(20));
        textColor = typedArray.getColor(R.styleable.RingProgressView_textColor1, textColor);
