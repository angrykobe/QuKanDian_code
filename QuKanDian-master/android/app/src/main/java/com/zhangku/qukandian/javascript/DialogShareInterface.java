...
public class DialogShareInterface {
    private OnShareListener mOnShareListener;

    public DialogShareInterface(OnShareListener context) {
    ...
    public String getToken() {
        return "Bearer " + UserSharedPreferences.getInstance().getString(Constants.TOKEN, "");
    }
