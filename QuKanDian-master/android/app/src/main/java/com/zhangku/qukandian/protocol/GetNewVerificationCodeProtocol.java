...
public class GetNewVerificationCodeProtocol extends BaseModel {

    private Call<ResponseBody> mMCall;
    private String mTell;

    public GetNewVerificationCodeProtocol(Context context, String tell,OnResultListener<Bitmap> onResultListener) {
    ...
    public void postRequest() {
        ...
        mMCall = getAPIService().getVerificationCodeImgNew(mAuthorization, mContentType,mTell);
