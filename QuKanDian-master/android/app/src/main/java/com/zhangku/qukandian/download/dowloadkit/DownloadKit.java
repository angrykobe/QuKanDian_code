...
import com.zhangku.qukandian.download.dowloadkit.core.ConfigRequestDone;
import com.zhangku.qukandian.download.dowloadkit.core.RequestKit;
import com.zhangku.qukandian.download.dowloadkit.core.SetUrl;
...
public class DownloadKit implements SetUrl,
	...
	public RequestKit url(String downloadUrl) {
		...
		String name = downloadUrl.substring(downloadUrl.lastIndexOf("/"),downloadUrl.length());
