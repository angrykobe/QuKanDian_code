 ...
 * ljs
 */
public class LuckTurntableWebActivity extends BaseNoActionBarActivity implements DialogShareInterface.OnShareListener {
    ...
    private final static String mLoadingText = "页面加载中...";
    ...
    protected void initViews() {
        ...
        mTitleTV.setText("");
        findViewById(R.id.titleBackIV).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onShareDialog(final String title, final String desc, final String imgUrl, final String url) {
        ...
        shareDialog.setOnSharedListener(new OnSharedListener() {
            ...
            public void onSharedListener(DetailsBean mDetailsBean, SHARE_MEDIA share_media) {
                UMImage sImg = new UMImage(LuckTurntableWebActivity.this, imgUrl);
                ...
                UMImage umImage = new UMImage(LuckTurntableWebActivity.this, UserManager.mShareBean.getWechatIcon());
                umImage.setThumb(sImg);

                web.setThumb(umImage);  //缩略图
                web.setDescription(desc);//描述

                new ShareAction(LuckTurntableWebActivity.this).setPlatform(share_media).setCallback(mUMShareListener)
                        .withMedia(web)
                        .share();
            }
        });
    ...
    private UMShareListener mUMShareListener = new UMShareListener() {
        ...
        public void onStart(SHARE_MEDIA share_media) {
            ToastUtils.showLongToast(LuckTurntableWebActivity.this, "正在打开应用");
        }

        @Override
        public void onResult(SHARE_MEDIA share_media) {
            ToastUtils.showLongToast(LuckTurntableWebActivity.this, "分享成功");
        }

        @Override
        public void onError(SHARE_MEDIA share_media, Throwable throwable) {
            if (throwable.toString().contains("没有安装应用")) {
                ToastUtils.showLongToast(LuckTurntableWebActivity.this, "没有安装应用");
            }
        }
            ...
            new GetShareImgProtocol(mContext, new BaseModel.OnResultListener<ShareBean>() {
                ...
                public void onResultListener(ShareBean response) {
                    ...
                    for (int i = 0; i < response.getShareFrientPosterItems().size(); i++) {
                        ...
                        GlideUtils.loadImage(mContext, response.getShareFrientPosterItems().get(i).getImageLink().replace("http://cdn.qu.fi.pqmnz.com","http://static.funnykandian.com"), new GlideUtils.OnLoadImageListener() {
                            @Override
                            public void onSucess(Bitmap bitmap, String url) {
